...
- The App Router exposes `/`, `/games/[id]`, `/games/[id]/play`, `/auth`, and `/leaderboard`. Shared UI lives in `components/`, game and score data helpers live in `lib/`, and component/unit tests use Vitest with React Testing Library.
