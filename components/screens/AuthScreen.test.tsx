...
describe("AuthScreen", () => {
  ...
  it("logs in with the entered username and navigates home", () => {
    render(
      <AuthProvider>
        <AuthScreen />
      </AuthProvider>,
    ...
    fireEvent.click(screen.getByText("ENTRAR AL VAULT"));
  ...
  it("shows the email field only on the sign-up tab", () => {
    ...
    expect(
      screen.queryByPlaceholderText("jugador@vault.gg"),
    ).not.toBeInTheDocument();
    fireEvent.click(screen.getByText("CREAR CUENTA"));
    expect(screen.getByPlaceholderText("jugador@vault.gg")).toBeInTheDocument();
  });
});
